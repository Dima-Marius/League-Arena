  ...
  return (
    <div className={style.post}>
        ...
        <div className={style['post-footer']}>
          <ul className={style.likes}>{likes?.length !== 0 && <p>Liked by</p>} {likes?.length !== 0 ? likes.map(item => <li className={style.liked} key={item}>{item} <span>,</span></li>) : 'No likes yet'}</ul>
        </div>
